...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (isTokenExist) {
      ...
      navigate('/external_document', { replace: true })
    }
  }, [navigate])
        ...
        await api
          ...
          .then((response) => {
            if (response.data.status) {
              ...
              localStorage.setItem('documentDisseminationToken', response.data.token)
              ...
              <CCard className="p-4" style={{ position: 'relative' }}>
                <CCardBody>
                  ...
                  <CForm
                    ...
                    validated={validated}
                  >
                    <h3 className="text-center mt-5">CMS Document Dissemination</h3>
